...
<div id="vote" class="wrap">
	...
	<c:forEach items="${subjects }" var="subject" varStatus="status">
		<li  <c:if test="${status.index%2==0 }">class="odd" </c:if>>
			<h4>
				<em><a href="${pageContext.request.contextPath }/m/doModify?id=${subject.id}">维护</a></em>
				<a href="${pageContext.request.contextPath }/m/doModify?id=${subject.id}">${subject.title}</a>
			</h4>
